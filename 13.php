...
<p>
<div class="table">
<div class="tablesplashleft"><img src="pics/splashleft.gif" height="995" width="300" /></div>
<div class="tablesplashright"><img src="pics/splashright.gif" height="995" width="300" /></div>
<div class="tablesplashup"><img src="pics/splashup.gif" /></div>
<div class="tablesplashdown"><img src="pics/splashdown.gif" /></div>
<table bgcolor="black" width="1000" cellpadding="15" cellspacing="5" height="995">
<tr>
	<td colspan="2" align="center" valign="middle"><table width="100%"><tr><td align="left" width="150"><img src="Logo.gif" height="150" /></td><td align="center"><div class="header" style="margin-right:120px;"><font size="+6">Delta Series</font></div></td></tr></table>
    </td>
</tr>
<tr>
	<td><img src="deltaa.gif" />
    </td>
    <td><div class="header">CPU</div><div class="bodym">Intel i5 3.1GHz Quad-Core</div><br /><div class="header">Memory</div><div class="bodym">8GB (2x4GB) DDR3-1333</div><br /><div class="header">Hard Drive</div><div class="bodym">1TB 7200RPM Internal Hard Drive</div><br /><div class="header">Video Card</div><div class="bodym">Asus Radeon HD 7770 2GB 1GHz 2 DVI Dual-Link outputs (1 DVI-D, 1 DIV-I) + 1 HDMI</div><br /><div class="header">Optical Drive</div><div class="bodym">Lite-On SuperMulti</div><br /><div class="header">Case</div><div class="bodym">NZXT Apollo Black NP Mid Tower</div><br /><div class="header">Operating System</div><div class="bodym">Windows 7 Home Premium</div><br />
    <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="J3AGG56H8WPEQ">
<table>
<tr><td><input type="hidden" name="on0" value="Shipping"><div class="body">Shipping</td></tr><tr><td><select name="os0">
	<option value="Local Pick Up">Local Pick Up (Wadsworth, OH) $829.00 USD</option>
	<option value="Economy Shipping">Economy Shipping $859.00 USD</option>
</select> </td></tr>
</table>
